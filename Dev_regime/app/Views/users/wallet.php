    ...
    <div class="min-h-screen flex overflow-hidden">
        ...
        <aside class="w-64 bg-white/60 backdrop-blur-xl border-r border-stone-200/60 flex-col hidden md:flex sticky top-0 h-screen z-10">
            ...
            <nav class="flex-1 px-4 py-8 space-y-1 overflow-y-auto">
                ...
                <a href="<?= site_url('users/wallet') ?>" class="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all duration-300 text-sm font-medium bg-stone-800 text-white shadow-md">
                            ...
                            <?php $count = 0; foreach($purchaseHistory as $purchase): ?>
                                ...
                                <div class="flex items-center justify-between p-6 hover:bg-stone-50 transition-colors">
                                    <div class="flex items-center gap-4 flex-1">
                                        ...
                                        <div>
                                            <p class="font-medium text-stone-800"><?= esc((string)($purchase->nom ?? 'Régime')) ?></p>
